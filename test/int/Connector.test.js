...
const Fakeyildiz = require("../Fakeyildiz");
const FakeTopic = require("../FakeTopic");
const FakeSubscription = require("../FakeSubscription");
testdouble.replace("@google-cloud/yildiz", Fakeyildiz);
...
describe("Connector INT", () => {
    ...
    describe("Source connects and streams", () => {
        ...
        it("should be able to run yildiz source config", () => {
    ...
    describe("Source topic doesn't exist", () => {
        ...
        it("should be able to run yildiz source config and create the topic", done => {
            const onError = _error => {
    ...
    describe("Source subscription doesn't exist", () => {
        ...
        it("should be able to run yildiz source config and create the subscription", done => {
            const onError = _error => {
                console.error(_error);
            };
    ...
    describe("Sink connects, creates topic and streams", () => {
        ...
        it("should be able to run the yildiz sink config", () => {
            const onError = _error => {
                error = _error;
            };
